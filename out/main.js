...
var ADMIN_ID = parseInt(process.env.ADMIN_ID);
var fs = require("fs");
var telegraf_1 = require("telegraf");
var bot = new telegraf_1["default"](TOKEN);
...
bot.on('message', function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(ctx.from.id == ADMIN_ID || getUsers().includes(ctx.from.username))) return [3 /*break*/, 4];
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
